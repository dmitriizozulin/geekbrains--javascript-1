...
let images = {
  ...
  setNextLeftImage() {
    ...
    const currentSlide = this.slides[this.currentIdx];
    currentSlide.classList.remove('hidden-slide');
    currentSlide.classList.add('rightToLeftAnimation');
    setTimeout(() => {
      currentSlide.classList.remove('rightToLeftAnimation');
    }, 500);
  },
  ...
  setNextRightImage() {
    ...
    const currentSlide = this.slides[this.currentIdx];
    currentSlide.classList.remove('hidden-slide');
    currentSlide.classList.add('leftToRightAnimation');
    setTimeout(() => {
      currentSlide.classList.remove('leftToRightAnimation');
    }, 500);
  },
};
